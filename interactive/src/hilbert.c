...
getIEEEBits(unsigned nDims,
	    unsigned ignoreMe __attribute__((unused)), /* ignored */
	    char const* cP,
	    unsigned y)
...
static unsigned
hilbert_box_vtx_work(unsigned nDims, unsigned nBytes, unsigned nBits __attribute__((unused)),
		     int findMin,
		     unsigned max __attribute__((unused)), unsigned y,
		     char* c1, char* c2,
		     unsigned rotation,
		     bitmask_t bits,
		     bitmask_t index,
 ...
 */
unsigned
hilbert_box_pt_work(unsigned nDims, unsigned nBytes, unsigned nBits __attribute__((unused)),
		    int findMin,
		    unsigned max, unsigned y,
		    char* c1, char* c2,
		    unsigned rotation,
